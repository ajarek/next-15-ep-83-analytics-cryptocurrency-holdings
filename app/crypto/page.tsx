...
const Crypto = ({
  ...
  searchParams: Promise<{ id: string; user: string; quantity: string }>
}) => {
    ...
    <div className='w-full min-h-screen flex flex-col justify-center items-center gap-4 '>
      ...
      <div className='w-full grid grid-cols-2 max-lg:grid-cols-1 gap-4 p-4 place-items-center '>
        ...
        <div className='flex flex-col items-start justify-center gap-4 p-4 text-xl'>
          ...
          <div className='flex items-center gap-3'>
            <span className='text-primary text-lg'>Cena:</span>
            {cryptoId?.price}$
          </div>
          <div className='flex items-center gap-3'>
            <span className='text-primary text-lg'>Zmiana 24h:</span>
            {cryptoId?.['change(24h)']}$
          </div>
          <div className='flex items-center gap-3'>
            <span className='text-primary text-lg'>Zmiana 7d:</span>
            {cryptoId?.['change(7d)']}$
          </div>
          <div className='flex items-center gap-3'>
            <span className='text-primary text-lg'>Wolumin 24h:</span>
            {cryptoId?.['Wol(24h)']}$
          </div>
          <div className='flex items-center gap-3'>
            <span className='text-primary text-lg'>Kapitalizacja: </span>
            {cryptoId?.capitalization}
          </div>
